...
CREATE TABLE public.customer(
	c_custkey integer NOT NULL, c_name character varying (25) COLLATE Pg_catalog."default" NOT NULL,
	c_address character varying (40) COLLATE Pg_catalog."default" NOT NULL, c_nationkey integer NOT NULL,
